...
CMD ["sh", "-c", "gunicorn -w ${WORKERS} -b 0.0.0.0:${PORT} --timeout 120 --access-logfile - src.document_processor_flask_api:app"]FROM ghcr.io/astral-sh/uv:python3.10-trixie-slim AS builder
